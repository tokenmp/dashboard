...
import { getUsageLedgerApi } from '@/api/usage';
const getUsageLedgerApiLazy = (p: UsageQuery) => getUsageLedgerApi(p);
...
import { getUsageQuotaApi } from '@/api/usage';
const getUsageQuotaApiLazy = (topN?: number) => getUsageQuotaApi(topN);
...
import { getPriceRulesApi } from '@/api/usage';
const getPriceRulesApiLazy = (p: UsageQuery) => getPriceRulesApi(p);
