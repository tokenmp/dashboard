...
import { getListingsApi } from '@/api/marketplace';
const getListingsApiLazy = (p: MarketplaceQuery) => getListingsApi(p);
...
import { getSettlementsApi } from '@/api/marketplace';
const getSettlementsApiLazy = (p: MarketplaceQuery) => getSettlementsApi(p);
...
import { getLedgerApi } from '@/api/marketplace';
const getLedgerApiLazy = (p: MarketplaceQuery) => getLedgerApi(p);
