...
import { getNoticesApi, getSystemConfigApi, getMigrationsApi } from '@/api/system';
...
function ConfigTab() {
  const { data, loading, error, reload } = useAsync(getSystemConfigApi);
  return (
    <div className="space-y-3">
...
const getMigrationsApiLazy = (p: SystemQuery) => getMigrationsApi(p);
