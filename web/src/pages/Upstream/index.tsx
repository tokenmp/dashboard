...
// 延迟引用避免循环
import { getProvidersApi } from '@/api/upstream';
const getProvidersApiLazy = (p: UpstreamQuery) => getProvidersApi(p);
...
import { getRouteGroupsApi } from '@/api/upstream';
const getRouteGroupsApiLazy = (p: UpstreamQuery) => getRouteGroupsApi(p);
...
import { getModelsApi } from '@/api/upstream';
const getModelsApiLazy = (p: UpstreamQuery) => getModelsApi(p);
